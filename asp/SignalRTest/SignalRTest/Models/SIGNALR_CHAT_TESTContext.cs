...
{
    public partial class SIGNALR_CHAT_TESTContext : DbContext
    {
        public SIGNALR_CHAT_TESTContext()
        {
        }

        public SIGNALR_CHAT_TESTContext(DbContextOptions<SIGNALR_CHAT_TESTContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ChatUser>(entity =>
            {
                entity.HasKey(e => e.Email)
                    .HasName("PK__ChatUser__AB6E616515A3AB7C");
